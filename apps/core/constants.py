...
NOTIFICATION_TYPE_ARRIVAL = "arrival"
NOTIFICATION_TYPE_ROUTE_CHANGE = "route_change"
NOTIFICATION_TYPE_SEAT_AVAILABILITY = "seat_availability"
NOTIFICATION_TYPE_TRIP_START = "trip_start"
NOTIFICATION_TYPE_TRIP_END = "trip_end"
NOTIFICATION_TYPE_ACHIEVEMENT = "achievement"
NOTIFICATION_TYPE_REWARD = "reward"
NOTIFICATION_TYPE_TRIP_UPDATE = "trip_update"
...
NOTIFICATION_TYPE_CHOICES = (
    ...
    (NOTIFICATION_TYPE_ARRIVAL, _("Bus Arrival")),
    (NOTIFICATION_TYPE_ROUTE_CHANGE, _("Route Change")),
    (NOTIFICATION_TYPE_SEAT_AVAILABILITY, _("Seat Availability")),
    (NOTIFICATION_TYPE_TRIP_START, _("Trip Started")),
    (NOTIFICATION_TYPE_TRIP_END, _("Trip Ended")),
    (NOTIFICATION_TYPE_ACHIEVEMENT, _("Achievement Unlocked")),
    (NOTIFICATION_TYPE_REWARD, _("Reward Earned")),
    (NOTIFICATION_TYPE_TRIP_UPDATE, _("Trip Update")),
)
